	...
	CommandLineRunner runner(QuestionBankService questionBankService) {
		return args -> {
			...
			new String[]{"Greater than 5", "5 or less", " 10", "no output"}, 
				0,
				"The if statement checks if x is greater than 5. Since x = 10, the condition is true, so it prints \"Greater than 5\". This question teaches basic conditional logic.", "");
			question question5 = new question(5, "How many times will the following loop run? \n for i in range (5): \n \t print(i)",
				new String[]{"4", "5", "6", "Infinite"}, 1, 
				"range(5) generates numbers from 0 up to (but not including) 5. Therefore, the loop iterates 5 times, printing numbers 0 through 4. This question highlights how range works in Python.", "");
			...
			question question7 = new question(7, "What will be the output of this code? \n \t python \n \t name=\"Alice\" \n \t print(name[0])", 
				...
				"Strings in Python are indexed starting from 0. name[0] accesses the first character in the string \"Alice\", which is A. This question introduces basic string indexing.", "");
			...
			question question9 = new question(9, "What will be the output of this code? \n print(5>3 and 2<4)",
				...
				"In Python, and is used to combine boolean conditions. Both 5 > 3 and 2 < 4 are true, so the result of andis True. This question reinforces basic boolean logic.", "");
